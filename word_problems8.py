...
input("Чтобы узнать. нажмите Enter.")
print("6*3=",6*3)
print("Ecли в ресторане вам с приятелями принесли счет на 19 долларов (считая чаевые).")
...
print("107/4=",107/4)
print("nEcли те же самые четверо пиратов разделят те же 107 монет из ларчика поровну")
